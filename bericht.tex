...
\begin{appendix}
  \begin{figure}[H]
    \centering
    \input{figures/scnpe_hmpuls4nognd.csv.pgf}
    \caption{\label{fig:label} }
  \end{figure}

  \begin{figure}[H]
    \centering
    \input{figures/scnpe_hmpuls4nognd1.csv.pgf}
    \caption{\label{fig:label} }
  \end{figure}

  \begin{figure}[H]
    \centering
    \input{figures/scnpe_hmpuls4nognd2.csv.pgf}
    \caption{\label{fig:label} }
  \end{figure}

  \begin{figure}[H]
    \centering
    \input{figures/scnpe_impuls1.csv.pgf}
    \caption{\label{fig:label} }
  \end{figure}

  \begin{figure}[H]
    \centering
    \input{figures/scnpe_impuls2.csv.pgf}
    \caption{\label{fig:label} }
  \end{figure}

  \begin{figure}[H]
    \centering
    \input{figures/scnpe_impuls3.csv.pgf}
    \caption{\label{fig:label} }
  \end{figure}

  \begin{figure}[H]
    \centering
    \input{figures/scnpe_minus.csv.pgf}
    \caption{\label{fig:label} }
  \end{figure}
